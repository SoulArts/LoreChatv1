...
function getUserDiv(user){
	var $div = $('<div id="avatar"><span class="avatar-bd-text"></span><img class="avatar-text" src="_assets/images/'+user.username+'.jpg">');
	var $username = $('<h1>').addClass('username username-title');
	...
	$username.html('<span class="default-icon vip"></span>'+user.username+'<span class="vip-player"></span>');
	$div.append($username);
